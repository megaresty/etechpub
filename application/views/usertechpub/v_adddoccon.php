                ...
                <div class="row">
                    <div class="col-md-12">
                    	<form>
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="vendor">
                                        ...
                                        <option>
											...
											echo '<option value="'.$row->vendor_desc.'">'.$row->vendor_desc.'</option>'; 
											}?>
                                        </option>
                                    </select>
                                </div>
                            	...
                            	<div class="form-group">
                                    ...
                                    <select class="form-control" name="doctype">
                                        ...
                                        <option>
											...
											echo '<option value="'.$row->doctype_desc.'">'.$row->doctype_desc.'</option>'; 
											}?>
                                        </option>
                                    </select>
                                </div>
                        	...
                        	<!---<form>-->
                                ...
                                <select class="form-control" name="enginelist">
                                	...
                                	<?php foreach($engine_name as $row){
										echo '<option value="'.$row->engine_name.'">'.$row->engine_name.'</option>'; 
									}?>
                                </select>
                                </div>
                            <!---</form>-->
                        	...
                        	<!--<form>-->
                                ...
                                <select class="form-control" name="aircraftlist">
                                    ...
                                    <?php foreach($aircraft_name as $row){
										echo '<option value="'.$row->aircraft_name.'">'.$row->aircraft_name.'</option>'; 
									}?>
                                </select>
                                </div>
                            <!--</form>-->
                        	...
                        	<!--<form>-->
                                ...
                                <select class="form-control" name="acreglist">
                                    ...
                                    <?php foreach($acreg as $row){
										echo '<option value="'.$row->acreg.'">'.$row->acreg.'</option>'; 
									}?>
                                </select>
                                </div>
                            <!--</form>-->
                        	...
                        	<!--<form>-->
                                ...
                                <select class="form-control" name="medialist">
                                    ...
                                    <?php foreach($media_name as $row){
										echo '<option value="'.$row->media_name.'">'.$row->media_name.'</option>'; 
									}?>
                                </select>
                                </div>
                            <!--</form>-->
                        	...
                        	<!--<form>-->
                                ...
                                <select class="form-control" name="capabilitylist">
                                    ...
                                    <?php foreach($capability_name as $row){
										echo '<option value="'.$row->capability_name.'">'.$row->capability_name.'</option>'; 
									}?>
                                </select>
                                </div>
                            <!--</form>-->
                         ...
                         <div class="col-md-1 col-sm-1 col-xs-12">
                            <a href="<?php echo base_url() ?>index.php/usertechpub/distribution" type="button" class="btn btn-sm btn-success">Distribution</a>
                         </div>
                    </form>
                    </div>
                </div>
