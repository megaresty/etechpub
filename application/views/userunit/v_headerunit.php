...
<head>
    ...
    <link href="<?php echo base_url(); ?>assets/assets2/css/font-awesome.css" rel="stylesheet" />
       <!--CUSTOM BASIC STYLES-->
    <link href="<?php echo base_url(); ?>assets/assets2/css/unitcss.css" rel="stylesheet" />
    <!--CUSTOM MAIN STYLES-->
                ...
                <ul class="nav" id="main-menu">
                    <li>
                        <div class="user-img-div">
                            <img src="<?php echo base_url(); ?>assets/assets2/img/user.png" class="img-thumbnail" />
                     ...
                     <li>
                        <a href="#">Registration <span class="fa arrow"></span></a>
                         <ul class="nav nav-second-level">
                             ...
                             <li>
                             	<a href="">New Aircraft</a>
                             </li>
                             <li>
                             	<a href="">New Aircraft Registration</a>
                             </li>
                             <li>
